export const PROJECTS = [
  {
    name: 'Join',
    englishDescription:
      'Task manager inspired by the Kanban System. Create and organize tasks using drag-and-drop functions, assign and categorize.',
    germanDescription:
    ...
    bosnianDescription:
      'Menadžer zadataka inspirisan Kanban sistemom. Kreirajte i organizujte zadatke koristeći funkcije povlači-i-ispusti, dodjeljujte i kategorizirajte.',
  ...
  },
  {
    name: 'Valyrie',
    englishDescription:
      'A simple Jump-and-Run game based on an object-oriented approach. Help Valkyrie to find coins and swords to fight against the Minotaur.',
    germanDescription:
    ...
    bosnianDescription:
      'Jednostavna Jump-and-Run igra bazirana na objektno-orijentisanom pristupu. Pomozite Valkiri da pronađe novčiće i mačeve kako bi se borila protiv Minotaura.',
